  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        However, such an account cannot be declared and applied. It has to be tested against particular questions — theoretical and practical, addressed to the church and to a public that does not share its assumptions — and it requires preparatory work on the categories through which knowledge and the human are described.

        The [projects](/projects/) gathered here are that testing and that preparation.
    design:
      columns: '1'
---
